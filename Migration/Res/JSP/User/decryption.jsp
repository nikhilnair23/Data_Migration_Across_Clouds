...
<%
	...
	ResultSet rs= userDAO.getDFiles1(userDAO.getID(userid));
	int count=0;
%>
<br></br>
<center>
 ...
 <%while(rs.next())
  ...
  <tr>
    <th scope="row"><%=count %></th>
    	...
    	<td><a href="<%=request.getContextPath() %>/Decrypt?fname=<%=rs.getString(6)%> &user=<%=userid%>"> Click Here To Decrypt</a></td>
  </tr>
<%} %>

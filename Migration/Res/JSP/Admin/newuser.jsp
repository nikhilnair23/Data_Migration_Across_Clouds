...
<script type="text/javascript" src="<%=request.getContextPath()%>/Res/Js/validate.js"></script>
...
<div id="registration">
 ...
 <form id="RegisterUserForm" action="<%=request.getContextPath() %>/NewUser" method="post">
 	<fieldset>
         <p>
            <label for="name">User ID</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input id="name" name="id" type="text" class="text" value="" required="yes"/>
            
            <label for="tel">Password</label>&nbsp;&nbsp;&nbsp;
            <input id="tel" name="pwd" type="password" class="text" value="" required="yes"/>
         </p><br>        
        
        
         <p>
            <label for="email">Name</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input id="email" name="name" type="text" class="text" value="" required="yes" />
             <label for="password">City</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input id="password" name="city" class="text" type="text" required="yes"/>
         </p><br>  
        
        
         <p>
            <label for="password">Email</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input id="password" name="email" class="text" type="email" required="yes" pattern="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"/>
         </p>
        
        <br>
        
         <p>
            <input type="submit" class="text1" value="Register"/>
         </p>
 	</fieldset>
...
{%>
<div id="amutha">
	<p id="message">Somthing went wrong...!</p>
</div>
<%}%>
<%if(no==5)
{%>

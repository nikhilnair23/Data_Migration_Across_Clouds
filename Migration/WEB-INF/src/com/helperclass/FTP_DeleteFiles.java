...
public class FTP_DeleteFiles 
{
	 
    public static boolean deleteFilesOnCloud(String directoryToCreate,String filename) throws Exception
    {
    	ArrayList<String> cloud = UserDAO.getCloudFirst();
       ...
       // String pass = "*blrstore123";
        ...
        String dirToCreate = "Cloud_SaDas/"+directoryToCreate;//create a direcory inside PHR_Records folder
       
        System.out.println("Cloud Directory :"+directoryToCreate+"File Name :"+filename);
        ...
        try 
        {
            ...
            success = ftpClient.deleteFile(dirToCreate+"/"+filename);
            ...
            if (success)
            {
                System.out.println("File Deleted Successfully : " + dirToCreate);
            } 
            else
            {
...
//            
    ...
    public static boolean deleteFilesOnCloud1(String directoryToCreate,String filename) throws Exception
    {
...
//            
    ...
    public static boolean deleteFilesOnCloud2(String directoryToCreate,String filename) throws Exception
    {
...
//            
    ...
    {
    	String folder ="user";
    	//FTP_DeleteFiles.deleteFilesOnCloud(folder);

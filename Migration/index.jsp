...
{%>
<div id="amutha">
	<p id="message">You password sent successfully to your Mail-ID(Gmail)...!</p>
</div>
<%}%>
...
<form id="login" action="<%=request.getContextPath()%>/AdminLogin" method="post">
    <h1 id="ff-proof" class="ribbon">Admin Login &nbsp;&nbsp;</h1>
   
    <fieldset id="inputs">
        <input id="username" type="text" name="username" onblur="if(this.value=='')this.value='admin name';" onfocus="if(this.value=='admin name')this.value='';"  required="yes" />
        <input id="password" type="password" name="pass" onblur="if(this.value=='')this.value='admin password';" onfocus="if(this.value=='admin password')this.value='';" required="yes"  />
    </fieldset>
    <fieldset id="actions">
        <input type="submit" id="submit" value="Login"/>
       <p class="option"><a href="<%=request.getContextPath() %>/index.jsp">Admin</a>&nbsp;&nbsp;|<a href="<%=request.getContextPath()%>/index1.jsp">User</p>
    </fieldset>
</form>
</body>
</html>